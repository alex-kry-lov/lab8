...
def simulate_game(num_doors, num_prizes):
  ...
  # Print results
  print(f"Player 1 staying wins: {player1_stays_rate:.2f}")
  print(f"Player 1 switching wins: {player1_switches_rate:.2f}")
  print(f"Player 2 staying wins: {player2_stays_rate:.2f}")

# Run the simulation for 3 doors and 1 prize
simulate_game(3, 1)
